	...
	<section class="flex flex-col sm:justify-between items-center sm:flex-row mt-12 sm:mt-10">
		...
		<div class="w-full md:w-1/3 text-left">
			...
			<p
				...
				Ph.D. in Automation and System Engineering

			</p>
			<p
				class="font-general-medium mt-2 text-lg sm:text-xl  xl:text-2xl text-center sm:text-left leading-none text-gray-400">
				Optimization and Machine learning researcher, Software Developer</p>
			<div class="flex justify-center sm:block">
				<a download="Alireza_Olama_CV.pdf" href="/files/Alireza_Olama_CV.pdf"
		...
		<div class="w-full md:w-1/3 text-right float-right">
			<img v-if="theme === 'light'" src="@/assets/images/mf.jpeg" alt="Developer" />
			<img v-else src="@/assets/images/mf.jpeg" alt="Developer" />
		</div>
	</section>
</template>
